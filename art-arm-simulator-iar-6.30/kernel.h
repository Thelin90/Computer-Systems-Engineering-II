...
exception       recieve_wait( mailbox* mBox, void* pData );
...
extern void     LoadContext( void );	// Restores DSP registers from TCB pointed to by 
extern void     freeWith_isr_off_on();
extern void     *secureCalloc();
...
void up();
void down();
void direction(int btn);
extern void task_1();
extern void task_2();
extern void task_3();

//Leak tests
extern volatile int leak;
extern volatile int upperLeak, downLeak;
